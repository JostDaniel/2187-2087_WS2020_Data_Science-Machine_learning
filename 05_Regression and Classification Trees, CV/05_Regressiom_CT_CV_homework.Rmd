...
We start by separating the voting data into train and test data. As usual the test data set is smaller because we do not want to lose a lot of observations when training the model, this also increases how our prediction works (DJ: WAS BEDEUTET DAS?). After splitting the data set
                                                                                                  #'''''''''#
...
**What would be the "naive prediction" in such a multiclass prediction problem?**
The naive prediction is that ÖVP would win (positive class)
