...
Compare Cross-Country Results - Variable Importance synthetic countries comparison
...
Cctree <- ctree(formula, data = data19, control = ctree_control(testtype = "Bonferroni", mincriterion = 0.99)) 
Cctree

plot(Cctree,gp = gpar(fontsize = 6),
  inner_panel=node_inner,
