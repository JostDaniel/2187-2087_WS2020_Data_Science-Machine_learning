...
<!-- Man kann von kategoriale Variablen (auch wenn ordinalskaliert) nicht einfach den mean berechnen, also können schon ist aber eher nix -->
...
After having finished the data wrangling of the synthetic EU Silc data for the six countries we now want to compare these countries to see how they differ in e.g. levels of inequality. 
