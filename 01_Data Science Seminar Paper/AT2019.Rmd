...
**TO DOs**
* Adapt Graphs - überschriften größer
...
data19_h <- data19_h %>% select(hy010, Hid) 
...
#### umschreiben income part falls - Änderung variable ####
...
data19 <- data19 %>% select(
  sex, hy010 ,P038004, P110000nu, P111010nu, alter, M009010, M010000, M014000, M016000, M017000, M020010, M021000, M025000, M027000, M028000, M004000, M001300, M001510, M003100, M001100, M001200, M002000, M001500) %>% 
  
  rename("net_income"        = hy010,       # gross annual income
  ...
  filter(age %in% (26:59), inc_net > 0, mother_present > 0, father_present > 0, father_cit > 0, mother_cit > 0)  %>%
  ...
  mutate( "inc_net_log" = log(net_income + 1),   
...
**Advantages of Trees:** Next to being rather straightforward to interpret using such an algorithm minimizes the degree of randomness and arbitrariness in model selection. Trees show outcome variability without initially assuming which circumstances play a significant role in shaping the individual opportunities or how they interact [@brunori18]. 

**Advantages of Trees over linear regression models:** very large set of observations can be used & model specification is no longer driven by the arbitrary decision of the researcher.
