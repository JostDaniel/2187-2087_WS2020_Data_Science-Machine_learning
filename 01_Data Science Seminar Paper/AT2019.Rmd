...
* Combine all the data in one RMD file - Don't Confuse names
...
# Gini Comparison across countries
```{r echo=T, message=FALSE, error=FALSE, warning=FALSE}

Gini_AT <- (ineq(AT_equality_data$annual_income, type = "Gini"))
Gini_FR <- (ineq(FR_equality_data$annual_income, type = "Gini"))
Gini_DK <- (ineq(DK_equality_data$annual_income, type = "Gini"))
Gini_ES <- (ineq(ES_equality_data$annual_income, type = "Gini"))
Gini_FI <- (ineq(FI_equality_data$annual_income, type = "Gini"))
Gini_IT <- (ineq(IT_equality_data$annual_income, type = "Gini"))
Gini_LV <- (ineq(LV_equality_data$annual_income, type = "Gini"))

Country <- (c("AT", "FR", "DK", "ES", "FI", "IT", "LV"))
Gini <- c(Gini_AT,Gini_FR,Gini_DK, Gini_ES, Gini_FI, Gini_IT, Gini_LV )
Gini <- data.frame(Gini,Country)
