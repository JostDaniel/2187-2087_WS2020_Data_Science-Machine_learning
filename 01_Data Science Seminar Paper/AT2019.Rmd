...
#umschreiben Age anpassen auf 27 hier oder oben sonst
...
```
The data set includes 25 variables and 3600 observation. There are almost no missing values after cleaning the data<!-- D: haben wir die gedropt? --> There are slight more females (52%) than males (48%). The income distribution is skewed to the right meaning the median income is lower than the mean income (we take the log to correct for this). 83% of respondents where born in Austria and 88& are Austrian citizens. In about 85% of respondents household at age 14 both parents where present and in 96% the mother was present....
<!-- TEXT missing -->
