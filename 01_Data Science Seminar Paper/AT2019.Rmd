...
"In either case, empirical results are sensitive to critical choices of model selection which are under complete discretion of the researcher.
First, researchers have to make a decision on which circumstance variables to consider for es- timation.2 Observablecircumstancesbeyondindividualcontrolaretypicallyasubsetofthereal number of exogenous variables a↵ecting individual outcomes. This issue has been largely dis- cussed by the literature, and the prevailing view is that partial observability implies downward- biased inequality of opportunity estimates"
