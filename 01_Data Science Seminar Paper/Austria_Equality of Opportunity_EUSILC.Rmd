...
AT_cct <- ctree(formula, data = AT_train, mincriterion = 0.99)

plot(AT_cct, type = "simple",gp = gpar(fontsize = 8),
  inner_panel=node_inner,
  ip_args=list(abbreviate = FALSE,id = FALSE), main = "Conditional Inference Tree for Austria 2011 - Cross Validated")
# AT_final_cTree <- AT_cctree$finalModel
# 
# plot(AT_final_cTree, type = "simple",gp = gpar(fontsize = 2),
#   inner_panel=node_inner,
#   ip_args=list(abbreviate = TRUE,id = FALSE), main = "Conditional Inference Tree for Austria 2011 - Cross Validated")
```
