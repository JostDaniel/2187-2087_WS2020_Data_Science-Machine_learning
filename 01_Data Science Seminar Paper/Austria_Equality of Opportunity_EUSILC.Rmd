...
equality_data <- equality_data %>% 
  rename("Sex" = PB150,
         "Citizenship" = PB220A,
         "Parents Present" = PT010,
         "Adults at home" = PT020, 
         "Working Adults" = PT030,
         "Father CoB" = PT060,
         "Father Cit" = PT070,
         "Mother CoB" = PT090,
         "Mother Cit" = PT100,
         "Father Educ" = PT110,
         "Mother Educ" = PT120,
         "Father Occup Stat" = PT130,
         "Mother Occup Stat" = PT160,
         "Father Main Occup" = PT150,
         "Mother Main Occup" = PT180,
         "Father Manag" = PT140,
         "Mother Manag" = PT170,
         "Tenancy" = PT210,)
```