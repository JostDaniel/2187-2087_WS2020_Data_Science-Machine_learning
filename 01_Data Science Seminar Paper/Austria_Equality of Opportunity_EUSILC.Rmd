...
formula <- log_income ~ sex + citizenship + parents_present + adults_home + children_14 + father_cob + father_cit + mother_coB + mother_cit + father_edu + mother_edu + father_occup_stat + mother_occup_stat + father_occup + mother_occup + father_manag + mother_manag + tenancy
