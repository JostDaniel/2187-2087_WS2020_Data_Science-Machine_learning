...
AT_cctree1 <- train(formula, data = AT_train, method = "ctree", trControl = AT_fitControl, na.action = na.pass)
...
AT_ctree2 <- ctree(formula, data = AT_equality_data, control = ctree_control(testtype = "Bonferroni")) 
AT_ctree2
